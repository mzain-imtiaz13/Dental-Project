    ...
    <div class="row g-3 mb-4">
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <p class="text-muted mb-3">Manage API credentials for external services to fetch orders, cases, and patient data.</p>
                    <div class="row g-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="card border-warning h-100">
                                <div class="card-body text-center">
                                    <i class="bi bi-hdd-network fa-2x text-warning mb-3"></i>
                                    <h6 class="card-title">Other APIs</h6>
                                    <p class="card-text small text-muted">Manage additional external APIs</p>
                                    <a href="{{ route('api-credentials.index') }}" class="btn btn-warning btn-sm">
