...
<head>
    ...
    <title>@yield('title', 'Dental Lab')</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <aside class="col-12 col-md-3 col-lg-2 p-3">
                <div class="card shadow-sm side-bar-height border-0">
                    <div class="card-header bg-blue-secondary text-white d-flex align-items-center border-0 py-3">
