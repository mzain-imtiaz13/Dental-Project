...
async function loadProfiles() {
    const res = await fetch('{{ route("profiles.index") }}', { headers: { 'Accept': 'application/json' }});
    ...
    document.getElementById('tbody').innerHTML = rows || `<tr><td colspan="7" class="text-center text-muted">No profiles</td></tr>`;
}
    ...
    body.innerHTML = `
        <div class="row g-3">
            <div class="col-md-8">
                ...
                <div class="mt-2">
                    <span class="badge bg-light text-dark border">${row.api || cred.name || 'Meditlink'}</span>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <dl class="row mb-0">
                            <dt class="col-5">UUID</dt><dd class="col-7">${g.uuid || '—'}</dd>
